...
import findLongAboutDescriptionService from "@/features/about_me/services/findLongAboutDescriptionService.js";
...
export default{
    ...
    created() {
        ...
        this.aboutDescription = this.splitPhrasesDescriptions(this.executeFindLongAboutDescription())
    },
    methods: {
    ...
    computed: {
        frontendSkills() {
            return this.executeListCertificationsByType(this.OPTIONS_VALUES.FRONTEND);
        },
        backendSkills() {
            return this.executeListCertificationsByType(this.OPTIONS_VALUES.BACKEND);
        },
        devtoolsSkills() {
            return this.executeListCertificationsByType(this.OPTIONS_VALUES.DEVTOOLS);
        },
        certifications(){
            return this.executeListCertifications();
        }
    }
}
