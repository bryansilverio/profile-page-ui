        ...
        onChangeOption(value='ALL'){
            ...
            setTimeout(function(){
                ...
                if(value==thix.OPTIONS_VALUES.ALL){
                    ...
                    thix.options.showCompanies=false;
                    thix.options.showPersonal=false;
                    thix.items=thix.executeListProjects();
                    return;
                }
                if(value==thix.OPTIONS_VALUES.COMPANY_PROJECT){
                    ...
                    thix.options.showPersonal=false;
                    thix.items=thix.executeListProjectsByProjectType(thix.OPTIONS_VALUES.COMPANY_PROJECT);
                    return;
                }
                if(value==thix.OPTIONS_VALUES.PERSONAL_PROJECT){
                    ...
                    thix.items=thix.executeListProjectsByProjectType(thix.OPTIONS_VALUES.PERSONAL_PROJECT);
                    return;
                }
            },500);
        }
