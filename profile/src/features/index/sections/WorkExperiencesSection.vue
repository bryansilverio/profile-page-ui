...
import findLastWorkExperiencesService from "@/features/index/services/findLastWorkExperiencesService.js";
import WorkExperienceItem from '@/components/shared/WorkExperienceItem.vue'
import SectionTitle from '@/components/shared/SectionTitle.vue'
export default {
    name: "WorkExperiencesSection",
    components: { WorkExperienceItem, SectionTitle },
    mixins:[findLastWorkExperiencesService],
    data() {
        return {
    ...
    created() {
        this.items = this.executeFindLastWorkExperiences();
