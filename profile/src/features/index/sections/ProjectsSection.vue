...
import findLastProjectsService from "@/features/index/services/findLastProjectsService.js";
import SectionTitle from '@/components/shared/SectionTitle.vue'
export default {
    name: "ProjectsSection",
    components: { ProjectItem, SectionTitle },
    mixins:[findLastProjectsService],
    data() {
        return {
    ...
    computed: {
        projects() {
            return this.executeFindLastProjects();
        }
    }
};
</script>
