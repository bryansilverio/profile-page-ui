          ...
          <div class="row align-items-center justify-content-center">
              ...
              <div class="col-lg-6">
                  <div class="about_content mt-45 wow fadeInLeftBig" data-wow-duration="1.3s" data-wow-delay="0.5s">
                      ...
                      <p>Mi nombre es Bryan Silverio, soy desarrollador de software y desarrollador web.</p>
                      <p>Inicie mi carrera profesional en 2016 en el desarrollo de web, he participado en diferentes empresas donde he trabajado en diferentes proyectos de diferentes sectores, actualmente estoy enfocado al diseño de desarrollo de apis rest y microservicios.</p>
                      <p>Decidi crear este sitio para tener mas presencia en internet y poder darme a conocer, asi como ofrecer servicios de desarrollo de software.</p>
