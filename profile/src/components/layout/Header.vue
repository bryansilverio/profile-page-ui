                          ...
                          <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                              <ul id="nav" class="navbar-nav ml-auto">
                                  <li class="nav-item active">
                                      <a class="page-scroll" @click="onGoToPage('/')">Home<span></span></a>
                                  </li>
                                  <li class="nav-item">
                                      <a class="page-scroll" @click="onGoToPage('about')">About<span></span></a>
                                  </li>
                                  <li class="nav-item">
              ...
              <div class="row align-items-center justify-content-center justify-content-lg-between">
                  <div class="col-lg-6">
                      <div class="header_hero_content mt-45">
                          <h5 class="header_sub_title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">Hola, soy</h5>
                          <h2 class="header_title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s">Bryan Silverio</h2>
                          <span class="wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.8s">Desarrador de software</span>
                          ...
                          <a href="https://rebrand.ly/freelancer-ud" rel="nofollow" class="main-btn wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="1.4s">Contactame</a>
